...
fn init_markdown_languages(languages: Arc<LanguageRegistry>) {
    use std::borrow::Cow;

    fn markdown_matcher() -> LanguageMatcher {
        LanguageMatcher {
            path_suffixes: vec![
                "md".into(),
                "mdx".into(),
        ...
        Arc::new(|| {
            Ok(LoadedLanguage {
                config: LanguageConfig {
                    name: LanguageName::new_static("Markdown"),
    ...
    languages.register_language(
        LanguageName::new_static("Markdown-Inline"),
        Some("markdown-inline".into()),
        ...
        Arc::new(|| {
            Ok(LoadedLanguage {
                config: LanguageConfig {
                    name: LanguageName::new_static("Markdown-Inline"),
                ...
                queries: LanguageQueries {
                    highlights: Some(Cow::Borrowed(include_str!(
                        "../../languages/src/markdown-inline/highlights.scm"
                    ))),
                    injections: Some(Cow::Borrowed(include_str!(
                        "../../languages/src/markdown-inline/injections.scm"
                    ))),
                    ..Default::default()
                },
                context_provider: None,
...
fn main() {
    ...
    app.run(move |cx| {
        ...
        init_markdown_languages(languages.clone());
...
pub(crate) async fn restore_or_create_workspace(
    ...
    if !RESTORE_PREVIOUS_WORKSPACES_ON_STARTUP {
        cx.update(|cx| {
            workspace::open_new(
                Default::default(),
                app_state,
